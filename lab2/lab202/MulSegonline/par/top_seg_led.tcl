...
# Generated on: Mon Mar 17 17:08:16 2025
...
if {$make_assignments} {
	...
	set_location_assignment PIN_A20 -to A[0]
	set_location_assignment PIN_B16 -to A[1]
	set_location_assignment PIN_A15 -to A[2]
	set_location_assignment PIN_B15 -to A[3]
	set_location_assignment PIN_A14 -to B[0]
	set_location_assignment PIN_B14 -to B[1]
	set_location_assignment PIN_A13 -to B[2]
	set_location_assignment PIN_B13 -to B[3]
